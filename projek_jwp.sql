...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2025 at 11:10 PM
...
ALTER TABLE `books`
  ADD PRIMARY KEY (`id`),
  ADD KEY `author_id_books` (`author_id`);
...
--
ALTER TABLE `books`
  ADD CONSTRAINT `author_id_books` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
